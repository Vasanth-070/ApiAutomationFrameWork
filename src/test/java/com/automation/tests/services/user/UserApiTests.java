package com.automation.tests.services.user;

import com.automation.framework.core.base.BaseApiTest;
import com.automation.framework.services.user.models.*;
...
public class UserApiTests extends BaseApiTest {
    ...
    public void setupTestData() {
        if (testDataProvider != null) {
            testDataProvider.loadTestData("src/main/java/com/automation/framework/services/user/data/userTestData.json");
